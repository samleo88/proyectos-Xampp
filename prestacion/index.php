...
$sesion = new sesion();
	...
	function validarUsuario($usuario, $password)
	{
		...
		$conexion = new mysqli("localhost","root","1234","prestaciones");
		$consulta = "select * from administrador where usuario = '$usuario' and  tipo=1";
        ...
        <div class="form-box" id="login-box">
            ...
            <form  name="frmLogin" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                ...
                <div class="footer">                                                               
				  ...
				  <center>  <p><a href="login.php">¿Entrar Como Invitado?</a></p>
