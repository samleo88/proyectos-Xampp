...
if ($num_total_registros > 0) {
	...
	$consulta = "SELECT cod, nombre, apellido,estado FROM empleados where estado='L' ORDER BY cod ASC LIMIT ".$inicio."," . $TAMANO_PAGINA;
...
?>
  ...
  <div class="box">
                                <div class="box-header">
                                    <h3> <center>Lista De Empleados  <a href="#" class="alert-link">/Liquidados</a></center></h3>                                    
                                </div>
...
<table id="example1" class="table  table-bordered table-striped">
  ...
  <tbody>
    <tr style="background:#6666666;">
	  ...
	  <td width="25%" scope="col">Opciones</td>
...
if($a==1){
								echo "
	  <a  href=agregarli.php?codigo=".$row["cod"]."><img src='../img/consul.png' width='25' alt='Edicion' title=' Realizar Liquidacion De ".$row["nombre"]."'></a>
	   <a  href=liquidacion.php?codigo=".$row["cod"]."><img src='../img/editar.png' width='25' alt='Edicion' title='EDITAR LIQUIDACION DE ".$row["nombre"]."'></a>"; } 
	   
	 echo " <a  href=mostrarl.php?codigo=".$row["cod"]."><img src='../css/images/liquidacion1.png' width='25' alt='Edicion' title=' Ver La Liquidacion De ".$row["nombre"]."'></a>
	 <a  href=anular.php?codigo=".$row["cod"]."><img src='../img/cancel.png' width='25' alt='Edicion' title='Anular Liquidacion De ".$row["nombre"]."'></a>
	 
	  <a target='_blank'  href=../pdf/liquidacionpdf.php?codigo=".$row["cod"]."><img src='../img/impresora.png'  width='25' alt='Edicion' title='Imprimir Liquidacion de ".$row["nombre"]."'></a>
	 </td>".
    "</tr>";
...
?>			
  ...
  <div class="box">
								...
								<center>
								<div class="box-header">
								   <h3> <center>Imprimir Lista De Liquidados</a></center></h3>                                    
                                </div>
								
								
								 <a target='_blank'  href=../pdf/lisadeliquidados.php><img src='../img/impresora.png'  width='50' alt='Edicion' title='Imprimir lista de Registro De empleados'></a>
								</center>
								</div>
								</div>
								</div>
