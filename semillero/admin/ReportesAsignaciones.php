      ...
      <div class="panel panel-success">
        ...
        <div class="panel-body">
            ...
            <div class="modal-body">
                    ...
                    <div class="form-group"> <label for="carrera" class="col-md-3 control-label">Busqueda por Contenido:</label>
                         <div class="col-md-4">
        ...
        <div class="panel-body">
            ...
            <div class="modal-body">
                     ...
                     <?php 
                        ...
                        <div class="form-group"> <label for="carrera" class="col-md-2 control-label">Seleccione Contenido:</label>
                         <div class="col-md-4">
                       <select class="form-control" id="asignatura" name="asignatura">
                     <?php 
