...
if(isset($_SESSION['NombreUsuario'])) {
   ...
   <script src="../js/jquery.js"></script>
    ...
    <script src="anios_academicos/myjava.js"></script>
        ...
        <div class="container">
            ...
            <div class="col-md-3"><img src="../imagenes/logoSIAD.png" width="80" height="80" class="img-responsive"></div>
             ...
             <div class="col-lg-12">
                    ...
                    <li class="active">Años Academicos</li>
                </ol>
            </div>
        </div> 
        <!-- /.row -->
...
<?php //include('otros/menuAdministrador.php') ?>
      ...
      <div class="panel panel-success">
        <div class="panel-heading">
            ...
            <center><h4><b>Administracion de Años Academicos</b></h4></center>
        </div>
        <div class="panel-body">
            <div class="row">
		               <div class="col-md-1"><h4>Buscar:</h4></div>
		               <div class="col-md-5">
		               <input type="text" name="s" id="bs-prod" class="form-control" placeholder="Escribir el Año Academico">
		               </div>
		               	<div class="col-md-6">
		                  <button id="nuevo-producto" class="btn btn-success"> <i class="glyphicon glyphicon-plus"></i> Nuevo Año Academico</button> 
		               </div>
	              <br>
 <br>
    ...
    <?php
include('conexion.php');
    $numeroRegistros = mysql_num_rows(mysql_query("SELECT * FROM years_academicos"));
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header" style="background:#337ab7; text-align: center;">
              ...
              <i class='glyphicon glyphicon-calendar'></i>&nbsp;&nbsp;Año Academico</b></h4>
            </div>
            ...
            <input type="text" class="form-control" required readonly id="id-registro" name="id-registro" readonly="readonly" style="visibility:hidden; height:5px;"/>
               ...
               <div class="form-group"> <label for="carnet" class="col-md-2 control-label">Año Academico:</label>
