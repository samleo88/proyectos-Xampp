...
if(isset($_SESSION['NombreUsuario'])) {
    ...
    <script src="carreras/myjava.js"></script>
...
<?php //include('otros/menuAdministrador.php') ?>
      ...
      <div class="panel panel-success">
        ...
        <div class="panel-body">
            <div class="row">
		               ...
		               <div class="col-md-5">
		               <input type="text" name="s" id="bs-prod" class="form-control" placeholder="Escribir el nombre del Semillero">
		               </div>
		               	<div class="col-md-6">
 ...
 <br>
    ...
    <?php
include('conexion.php');
    $numeroRegistros = mysql_num_rows(mysql_query("SELECT * FROM carreras"));
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header" style="background:#337ab7; text-align: center;">
              ...
              <i class='glyphicon glyphicon-th-list'></i>&nbsp;&nbsp;Contenidos</b></h4>
            </div>
            ...
            <input type="text" class="form-control" required readonly id="id-registro" name="id-registro" readonly="readonly" style="visibility:hidden; height:5px;"/>
               ...
               <div class="form-group"> <label for="carnet" class="col-md-2 control-label">Contenidos:</label>
