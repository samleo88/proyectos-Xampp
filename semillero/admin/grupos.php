...
<?php //include('otros/menuAdministrador.php') ?>
      ...
      <div class="panel panel-success">
        <div class="panel-heading">
            ...
            <center><h4><b>Administracion de Grupos</b></h4></center>
        </div>
        <div class="panel-body">
            <div class="row">
		               ...
		               <input type="text" name="s" id="bs-prod" class="form-control" placeholder="Escribir el nombre del Grupo">
		               	...
		               	<div class="col-md-6">
		                  <button id="nuevo-producto" class="btn btn-success"> <i class="glyphicon glyphicon-plus"></i> Nuevo Grupo de Clase</button> 
		               </div>
	              <br>
 <br>
    ...
    <?php
include('conexion.php');
    $numeroRegistros = mysql_num_rows(mysql_query("SELECT * FROM grupos"));
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header" style="background:#337ab7; text-align: center;">
              ...
              <i class='glyphicon glyphicon-align-justify'></i>&nbsp;&nbsp;Grupo</b></h4>
            </div>
