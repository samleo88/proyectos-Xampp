...
if(isset($_SESSION['NombreUsuario'])) {
     if ($_SESSION["NivelUsuario"] == 1) {
        ...
        ?>
		  ...
		  $consulta3 ="select idEstudiante, concat (NombresEstudiante, ' ', ApellidosEstudiante) as Estudiante from estudiantes";
...
<?php //include('otros/menuAdministrador.php') ?>
      ...
      <div class="panel panel-success">
        <div class="panel-heading">
            ...
            <center><h4><b>Incripciones de Contenidos</b></h4></center>
        </div>
        <div class="panel-body">
          ...
          <div class="form-group"> <label for="carrera" class="col-md-3 control-label">Semilleros:</label>
                         <div class="col-md-9">
                       <select class="form-control" id="carrera" name="carrera">
                       <option>---- Seleccione una Semillero -----</option>
                      <?php 
                       ...
                       <div class="form-group"> <label for="carrera" class="col-md-3 control-label">Contenidos:</label>
                         <div class="col-md-9">
                       <select class="form-control" id="asignaturas" name="asignaturas">
                        <option>---- Seleccione una Contenido -----</option>
                      <?php 
              ...
              <div style="margin-top: 10px"> <center><input type="submit" value="Inscribir Contenido"  class="btn btn-success" /></center>    </div>         
             </div>         
            </form>
	              <br>
 <br>
...
$registro = mysql_query("SELECT inscripciones_asignaturas.idInscripcion as id, carreras.NombreCarrera as Carrera, asignaturas.NombreAsignatura as Asignatura, concat(estudiantes.NombresEstudiante, ' ' ,estudiantes.ApellidosEstudiante) as Estudiantes,
