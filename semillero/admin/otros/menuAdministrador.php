         ...
         <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body">
                        <h4 class="media-heading">Asignaciones Docentes</h4>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body">
                        <h4 class="media-heading">Grupos Asignaciones</h4>
         ...
         <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body">
                      <h4 class="media-heading">Incripciones Contenido</h4>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body">
                       <h4 class="media-heading">Contenidos</h4>
                       <p>Total de Contenidos: <span class="label label-danger pull-right"><?php echo $TotalAsignaturas ?></span></p>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body">
                         <h4 class="media-heading">Semillero</h4>
