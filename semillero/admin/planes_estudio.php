...
if(isset($_SESSION['NombreUsuario'])) {
     if ($_SESSION["NivelUsuario"] == 1) {
        ...
        ?>
          ...
          $carrera=mysql_query($consulta1);
           $consulta4="select idAsignatura, NombreAsignatura from asignaturas";
          $asignatura=mysql_query($consulta4);
        ?>
    ...
    <script src="planes_estudio/myjava.js"></script>
...
<?php //include('otros/menuAdministrador.php') ?>
      ...
      <div class="panel panel-success">
        <div class="panel-heading">
            ...
            <center><h4><b>Administracion de Planes de Estudio</b></h4></center>
        </div>
        <div class="panel-body">
            <div class="row">
		               <div class="col-md-1"><h4>Buscar:</h4></div>
		               <div class="col-md-5">
		               <input type="text" name="s" id="bs-prod" class="form-control" placeholder="Escribir la descripcion 0 el nombre del Plan de Estudios">
		               </div>
		               	<div class="col-md-6">
		                  <button id="nuevo-producto" class="btn btn-success"> <i class="glyphicon glyphicon-plus"></i> Nuevo Plan de Estudio</button> 
		               </div>
	              <br>
 <br>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header" style="background:#337ab7; text-align: center;">
              ...
              <i class='glyphicon glyphicon-calendar'></i>&nbsp;&nbsp;Plan de Estudio</b></h4>
            </div>
            ...
            <input type="text" class="form-control" required readonly id="id-registro" name="id-registro" readonly="readonly" style="visibility:hidden; height:5px;"/>
               ...
               <div class="form-group"> <label for="carnet" class="col-md-2 control-label">Plan:</label>
				<div class="col-md-10"><input type="text" class="form-control" id="nombre" name="nombre" required maxlength="50"></div>
                     ...
                     <?php 
                        ...
                        <div class="form-group"> <label for="year" class="col-md-2 control-label">Contenido:</label>
                         <div class="col-md-10">
                       <input type="number" class="form-control" id="asignatura" name="asignatura" required maxlength="50">
                       </div>
                    </div> <br>
                 <div id="mensaje"></div>           
             </div>         
