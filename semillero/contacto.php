    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <!-- Embedded Google Map -->
                <iframe width="100%" height="400px" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="http://maps.google.com/maps?hl=en&amp;ie=UTF8&amp;ll=4.6292282,-74.0720926&amp;spn=4.6292229,-74.0699039&amp;t=m&amp;z=4&amp;output=embed"></iframe>
            </div>
            <!-- Contact Details Column -->
            <div class="col-md-4">
                <h3>Detalles de Contacto</h3>
                <p>
                    UNINPAHU<br>sede principal<br>
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">Telefono</abbr>: (1) 3323500</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">WEB</abbr>: <a href="https://www.uninpahu.edu.co/aspirantes/">Aspirante</a>
                </p>
                <p><i class="fa fa-clock-o"></i> 
                    <abbr title="Hours">Horario</abbr>: Lunes a Viernes: 8:00 AM - 7:00 PM</p>
