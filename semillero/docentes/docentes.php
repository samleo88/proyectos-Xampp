 ...
 ?>
			...
			<div class="col-md-3 col-sm-6">
                <div class="panel panel-default text-center">
                    <div class="panel-heading">
                        <span class="fa-stack fa-5x">                 
                              <img src="../imagenes/planificacion.png" class="img-responsive">
                        </span>
                    </div>
                    <div class="panel-body">
                        <h4>Actas de reunion</h4>
                        <a href="actas.php" class="btn btn-primary"> <i class="glyphicon glyphicon-download"></i>   Entrar</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
