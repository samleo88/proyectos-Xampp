...
$(function(){
	...
	$('#asignatura').on('keyup',function(){
		var dato = $('#asignatura').val();
		var url = 'entrega_tareas_estudiantes/busca_entrega_tarea.php';
		$.ajax({
		type:'POST',
		url:url,
		data:'dato='+dato,
...
function pagination(partida){
	var url = 'entrega_tareas_estudiantes/paginar_entrega_tarea.php';
	$.ajax({
		type:'POST',
		url:url,
