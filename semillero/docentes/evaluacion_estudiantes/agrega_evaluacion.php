...
switch($proceso){
	case 'Registro': mysql_query("INSERT INTO evaluaciones (Descripcion, idEstudiante, idAsignatura, Unidad, Tarea, idDocente, Puntaje, FechaEvaluacion) VALUES('$descripcion', '$estudiante','$asignatura','$unidad','$tarea','$codigo','$puntaje','$fechaEvaluacion')");
	break;
	case 'Edicion': mysql_query("UPDATE evaluaciones SET Descripcion = '$descripcion', idEstudiante = '$idEstudiante',idAsignatura = '$asignatura',Unidad = '$unidad',Tarea = '$tarea',Puntaje = '$puntaje',FechaEvaluacion = '$fechaEvaluacion' where idEvaluacion = '$id'");
	break;
   }
    $registro = mysql_query("
SELECT evaluaciones.idEvaluacion as id,
evaluaciones.Descripcion as Evaluacion,
estudiantes.CarnetEstudiante as carnet,
concat (estudiantes.NombresEstudiante,' ', estudiantes.ApellidosEstudiante) as Estudiante,
 asignaturas.NombreAsignatura as Asignatura,  
...
where  docentes.idDocente = '$codigo' ORDER BY evaluaciones.idEvaluacion ASC");
