...
SELECT
 evaluaciones.idEvaluacion as id,
 ...
 evaluaciones.Tarea as Tarea,
 concat (docentes.NombresDocente,' ',docentes.ApellidosDocente) as Docente,
 evaluaciones.Puntaje as Puntaje,
 evaluaciones.FechaEvaluacion as Fecha
