...
class PDF extends FPDF
{
		function Header()
		{
			...
			$this->Cell(35, 8, 'Docente' ,1,0,'C');
			$this->Cell(35, 8, 'Contenido' ,1,0,'C');
			$this->Cell(10, 8, 'Grupo' ,1,0,'C');
			$this->Cell(15, 8, 'Turno' ,1,0,'C');
			$this->Cell(30, 8, 'Horario' ,1,0,'C');
			$this->Cell(10, 8, 'Estado' ,1,0,'C');
			$this->Ln(8);
		}
		function Footer()
		{
        ...
        $item = 0;
			while($asignaciones2 = mysql_fetch_array($asignaciones)){
				...
				$pdf->Cell(35, 8, utf8_decode($asignaciones2['Docente']), 0,'C');
				$pdf->Cell(35, 8, utf8_decode($asignaciones2['Asignatura']), 0,'C');
				$pdf->Cell(10, 8, $asignaciones2['Grupo'], 0,'C');
			    $pdf->Cell(15, 8, $asignaciones2['Turno'], 0,'C');
			   	$pdf->Cell(30, 8, $asignaciones2['Horario'], 0,'C');
			   	$pdf->Cell(10, 8, $asignaciones2['Estado'], 0,'C');
				$pdf->Ln(5);
			}
			$pdf->Ln(8);
