 ...
 <a href="inscripcion_asignatura.php"> <button class="btn btn-warning" style="float: left; "><i class="fa fa-arrow-left"></i> Volver al Listado</button> </a> 
        ...
        <div class="panel-body">
          ...
          <div class="form-group"> <label for="carrera" class="col-md-3 control-label">Semillero:</label>
                       ...
                       <option>---- Seleccione un Semillero-----</option>
                      <?php 
					...
					<!--<div class="form-group"> <label for="carrera" class="col-md-3 control-label">Contenido:</label>
                         <div class="col-md-9">
                       <select class="form-control" id="asignatura" name="asignatura">
                        <option>---- Seleccione un contenido-----</option>
                      <?php 
              ...
              <div style="margin-top: 10px"> <center><input type="submit" value="Incribir Contenido"  class="btn btn-success" /></center>    </div>         
             </div>         
            </form>
                            </div>
                        </div>                  
        ...
        <div class="panel-heading">
            <div class="btn-group pull-right">
            </div><center><h4><b>Listado de Contenido a Inscrito</b></h4></center></div>
        <div class="panel-body" >
            <div class="row">        
                   <div style="margin-left: : 10px; margin-right: 10px;">
