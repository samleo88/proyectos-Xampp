 ...
 ?>
      ...
      <div class="panel panel-primary">
        <div class="panel-heading">
            ...
            <center><h4><b> <i class="glyphicon glyphicon-list-alt"></i> &nbsp; Mis Materiales de Estudio</b></h4></center>
        </div>
        <div class="panel-body">
            <div class="row">
                  <!--Fin del Segundo Row !-->
                   ...
                   <div class="col-md-5">
		                  <input type="text" name="s" id="bs-prod" class="form-control" placeholder="Escribe el Codigo del Material">
		               </div>
	              <br>
            <br>
            <br>
