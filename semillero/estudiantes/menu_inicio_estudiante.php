					 ...
					 <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header bg-light-blue">
                                    ...
                                    <p>
										<?php echo $estudiante ?> <!-- aca se trae el nombre y el apellido del usuario -->
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        ...
                        <div class="pull-left info">
                            <p>HOLA <br> <?php echo $estudiante ?></p>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active">
                            ...
                            <a href="estudiantes.php" data-ajax="false">
							
                                <i class="fa fa-th"></i> <span>Principal</span> 
                            </a>
                        </li>
						<li class="active">
							<a href="inscripcion_asignatura.php" class="list-group-item"><i class="glyphicon glyphicon-pencil"></i>   &nbsp;&nbsp;Asignaturas Inscritas
						...
						<li class="active">
							 <a href="tareas_recibidas.php" class="list-group-item"> <i class="glyphicon glyphicon-book"></i>   &nbsp;&nbsp; Mis Estadisticas
							</a>
						</li>
						<li class="active">
