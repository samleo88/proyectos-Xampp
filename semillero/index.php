...
<br>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">
                     Sistema de Informacion Administrativo Docente 
                </h1>
            </div>
            <div class="col-lg-12">
                <p>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header">Que puedes hacer</h2>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <img class="img-responsive img-circle" src="imagenes/estudiantes.png" width="400" height="250"  alt="">
            </div>
        </div>
        <!-- /.row -->
   <hr>
